...
class CreateOrdersTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->string('ship_full_name', 250)->nullable();
            $table->string('ship_address1', 100)->nullable();
            $table->string('ship_address2', 100)->nullable();
            $table->string('ship_carrier', 45)->nullable();
            $table->string('ship_tracking_number', 45)->nullable();
            $table->dateTime('ship_last_tracked_at')->nullable();
            $table->dateTime('ship_estimated_arrival_date')->nullable();
            $table->dateTime('ship_delivered_date')->nullable();
